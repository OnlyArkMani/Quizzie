...
class TestEvaluationService:
    def test_all_correct(self, db, examiner_user):
        ...
        attempt = ExamAttempt(exam_id=exam.id, student_id=student_id,
    ...
    def test_all_wrong(self, db, examiner_user):
        ...
        attempt = ExamAttempt(exam_id=exam.id, student_id=uuid.uuid4(),
                              status=AttemptStatus.SUBMITTED)
        db.add(attempt)
        db.commit()
    ...
    def test_status_set_to_evaluated(self, db, examiner_user):
